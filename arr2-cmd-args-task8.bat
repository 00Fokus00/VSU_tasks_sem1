...
rem большинства перечисленных jar-файлов
...
rem  в проект)
rem
rem Обязательно наличие только commons-cli-1.4.jar
rem
rem Также обратите внимание на .\out\artifacts\jar
rem

set M2_HOME=%USERPROFILE%\.m2
set CP=%CD%\out\production\Test
...
%JAVA% -classpath "%CP%" ru.vsu.cs.course1.Task8_14.Program %*
